...
$$
    \frac{\binom{n}{2} \times \binom{n-2}{2} \times \cdots \times \binom{2}{2}}{(N/2)!} = \frac{N!}{2^{N/2} (N/2)!}
$$
...
解き直して AC したものの、計算量の見積もりがうまくできてなかったので実質解説 AC.
$N$ が奇数のときに頂点を一つ足してその辺との重みは $0$ とするのは同じ。
